...
internal interface AppStorageFolderProvider {
...
internal class AppStorageFolderProviderImpl : AppStorageFolderProvider {


    private companion object {

        private const val APP_STORAGE_FOLDER_NAME = "DocsScanner"
