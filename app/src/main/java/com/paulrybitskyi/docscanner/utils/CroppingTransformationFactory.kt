...
import com.paulrybitskyi.docscanner.ui.views.doccropper.CroppingTransformation
import com.paulrybitskyi.docscanner.ui.views.imagecropper.CroppingCoords
import javax.inject.Provider


internal interface CroppingTransformationFactory {

    fun createCroppingTransformation(
        croppingCoords: CroppingCoords,
        viewSize: Pair<Float, Float>
    ): CroppingTransformation

}


internal class CroppingTransformationFactoryImpl(
